...
class _$TaskModelImpl implements _TaskModel {
  ...
  @override
  String toString() {
    return 'TaskModel(id: $id, content: $content, description: $description, commentCount: $commentCount, isCompleted: $isCompleted, order: $order, priority: $priority, projectId: $projectId, labels: $labels, due: $due, sectionId: $sectionId, parentId: $parentId, creatorId: $creatorId, createdAt: $createdAt, assigneeId: $assigneeId, assignerId: $assignerId, url: $url)';
  }
...
abstract class _TaskModel implements TaskModel {
  const factory _TaskModel(
      ...
      required final String url}) = _$TaskModelImpl;
